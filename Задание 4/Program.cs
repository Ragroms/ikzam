namespace Задание_4 // Дана квадратная матрица A[N, N]. Записать на место отрицательных элементов матрицы нули, а на место положительных — единицы.Вывести на печатьнижнюю треугольную матрицу в общепринятом виде.
{
    using System;
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < N; i++) // заполняем матрицу случайными значениями
            {
                for (int j = 0; j < N; j++)
                {
                    ...
                    Console.Write("{0}", A[i, j]); // выводим элементы матрицы на экран
                }
                Console.WriteLine();
            }
            Console.WriteLine();
