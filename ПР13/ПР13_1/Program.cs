using System;
using System.IO;
// Разработать программу, реализующую работу со структурой. В программе необходимо создать базу данных (массив структур) из N записей (N – определяется при работе программы), выполнить просмотр и поиск записи по заданному критерию (вводится при работе программы).*Данные можно считывать из текстового файла (на оценку - 5). Детский сад. Информация о дошкольниках: ФИО ребёнка, дата рождения, адрес проживания, уровень подготовки (значение 1-5).
